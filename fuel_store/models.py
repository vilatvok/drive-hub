...
from .tasks import get_price, get_default_price

from users.tasks import check_orders
...
class Fuel(models.Model):
    ...
    comment = GenericRelation(Comment, related_query_name="fuel_comment")
...
class Order(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if self.owner.orders.all().count() == 50:
            check_orders.delay(self.owner.id)
        return super().save(*args, **kwargs)

...
from cars.models import FuelCar, ElectricCar, Fine
...
class CarTest(APITestCase):
    ...
    def test_create(self):
        ...
        self.assertEqual(response.status_code, HTTP_201_CREATED, response.content)
        self.assertEqual(response_.status_code, HTTP_201_CREATED, response.content)
